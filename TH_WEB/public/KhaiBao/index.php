    ...
    <section class="home" id="home">
        ...
        <div class="container">
            ...
            <div class="row min-vh-100 align-items-center pt-5">
                ...
                <div class="col-md-6">
                    <img src="https://img.freepik.com/free-vector/family-protected-from-virus_23-2148575207.jpg?w=996.png" class="w-100" alt="">
                </div>
                ...
                <div class="container includes">
                    <div class="row mb-10">
                        <div class="col-md-12   col-12 khaiho ">
                            <label class="number-checkbox" style="font-weight: 600; font-size: 16px"><span class="mr-10">Khai hộ </span><input id="input73649" type="hidden" value="0" name="fields[otherUser]" class="style-checkbox" readonly="readonly"><input id="checkbox73649" type="checkbox" value="1" class="input73649 style-checkbox" onclick="$('#input73649').val(this.checked?1:0).change()">
                            </label>
                        </div>
                    </div>
                    <b>
                    ...
                    <div class="row info-namPas-box">
                        <div class="col-md-4 col-12 ten ">
                            <div class="form-group label-240 ">
                                ...
                                <input class="form-control" name="fullname_kbyt" type="text" style="text-transform: uppercase;" data-msg-required="Bạn chưa nhập họ tên">
                            </div>
                        </div>
                        <div class="col-md-4 col-12 cmnd ">
                            <div class="form-group  ">
                                <label>Số hộ chiếu / CMND / CCCD</label>:
                                <input class="form-control" name="passport_kbyt" type="text" value="" data-msg-required="Bạn chưa nhập CMT, hộ chiếu">
                            </div>
                        </div>
                        <div class="col-md-4 col-12 sdt ">
                            <div class="form-group label sdt ">
                                ...
                                <input class="form-control" name="sdt_kbyt" type="text" value="" data-msg-required="Bạn chưa nhập Số điện thoại">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row info-BD/QT-box">
                        <div class="col-md-4 col-12 ngay_sinh">
                            <div class="form-group">
                                ...
                                <input class="datetimepicker-input input_birthday form-control" name="birthday_kbyt" type="DD/MM/YYYY" placeholder="DD/MM/YYYY"><input type="text" class="input_birthday form-control" id="combodate" placeholder="DD/MM/YYYY" style="display: none;">
                            </div>
                        </div>
                    ...
                    <div class="row info-diachinha1-box">
                        <div class="col-md-6 col-12 dc1 ">
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="sonha_kbyt" type="text" value="" data-msg-required="Bạn chưa nhập số nhà/ tên đường">
                            </div>
                        </div>
                        <div class="col-md-6 col-12 xaphuong ">
                            <div class="form-group ">
                                <label>Xã Phường <span class="text-danger"> (*)</span>: </label>
                                <input class="form-control" name="xaphuong_kbyt" type="text" value="" data-msg-required="Bạn chưa nhập xã/phường">
                            </div>
                        </div>
                    </div>
                    <div class="row info-diachinha1-box">
                        <div class="col-md-6 col-12 quanhuyen ">
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="quanhuyen_kbyt" type="text" value="" data-msg-required="Bạn chưa nhập Quận/Huyện">
                            </div>
                        </div>
                        <div class="col-md-6 col-12 tinh ">
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="tinh_kbyt" type="text" value="" data-msg-required="Bạn chưa nhập Tỉnh">
                            </div>
                        </div>
                    </div>
                    <div class="row info-diachinha1-box">
                    ...
                    <div class="form-group form-lenght ">
                        ...
                        <div class="mt-10 inline-block pl-10"> <input type="radio" name="showCountrypassing_kbyt" value="0" class="style-radio" checked=""> Không
                    ...
                    <div class="col-12 wrap_trieuchung">
                        <div class="form-group">
                            <span class="text_note_1 text-primary font-weight-bold" translate="ban_co_thay_nhung_trieu_chung_nao">Anh/Chị hiện có những triệu chứng hay biểu
                                    ...
                                    <tbody id="list-trieuchung">
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="sot1" name="trieuchung_sot_kbyt" class="radio-trieuchung" value="1"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="sot1" name="trieuchung_sot_kbyt" class="radio-trieuchung" value="0" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="ho1" name="trieuchung_ho_kbyt" class="radio-trieuchung" value="1"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="ho1" name="trieuchung_ho_kbyt" class="radio-trieuchung" value="0" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="dauhong1" name="trieuchung_dauhong_kbyt" class="radio-trieuchung" value="1"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="dauhong1" name="trieuchung_dauhong_kbyt" class="radio-trieuchung" value="0" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="matmui1" name="trieuchung_matmui_kbyt" class="radio-trieuchung" value="1"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="matmui1" name="trieuchung_matmui_kbyt" class="radio-trieuchung" value="0" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="met1" name="trieuchung_met_kbyt" class="radio-trieuchung" value="1"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="met1" name="trieuchung_met_kbyt" class="radio-trieuchung" value="0" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="khotho1" name="trieuchung_khotho_kbyt" class="radio-trieuchung" value="1"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="khotho1" name="trieuchung_khotho_kbyt" class="radio-trieuchung" value="0" checked=""></label>
                                            </td>
                                        </tr>
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody id="list-dichte">
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="maccovid" name="dichte_benh_kbyt" class="radio-dichte" value="1" data-mucdo="2"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="maccovid" name="dichte_benh_kbyt" class="radio-dichte" value="0" data-mucdo="2" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="tiepxuccovid" name="dichte_tiepxuc_kbyt" class="radio-dichte" value="1" data-mucdo="2"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="tiepxuccovid" name="dichte_tiepxuc_kbyt" class="radio-dichte" value="0" data-mucdo="2" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="dituvungkhac" name="dichte_quocgiapassing_kbyt" class="radio-dichte" value="1" data-mucdo="2"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="dituvungkhac" name="dichte_quocgiapassing_kbyt" class="radio-dichte" value="0" data-mucdo="2" checked=""></label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="xuatviencovid" name="dichte_dieutri_kbyt" class="radio-dichte" value="1" data-mucdo="0"></label>
                                            </td>
                                            <td class="text-center td-center">
                                                <label class="lb-radio"><input type="radio" id="xuatviencovid" name="dichte_dieutri_kbyt" class="radio-dichte" value="0" data-mucdo="0" checked=""></label>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="textarea_kbyt" rows="2" class="form-control input_note" placeholder="Vui lòng cung cấp thêm thông tin về triệu chứng hay dấu hiệu khác nếu có" data-bind="value:ghi_chu">
                    </textarea>
                        <br />
                    </div>
                    ...
                    <div class="row maxacthuc">
                        <div class="col-md-8  nhapma ">
                            <div class="form-group label-240 ">
                                ...
                                <input class="form-control" name="maxacthuc" type="text" value="" style="text-transform: uppercase;" data-msg-required="Bạn chưa nhập mã xác thực">
